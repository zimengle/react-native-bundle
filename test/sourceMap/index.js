/**
 * node ./local-cli/cli.js bundle --assets-dest ./bundles --bundle-output ./bundles/fake.android.bundle --dev false --entry-file fake.android.js --platform android --sourcemap-output ./bundles/fake.android.sourcemap.json
 */
'use strict'
...
let commonBundleCode = fs.readFileSync('/Users/zhangzimeng/Workspace/rn35/.packCommon/android/bundle.js', 'utf8');

let reDefine = /^__d\((\d+)/;
let reNewline = /\r\n|\r|\n/;
let commonSMC = new sourceMap.SourceMapConsumer(
  JSON.parse(fs.readFileSync('/Users/zhangzimeng/Workspace/rn35/.packCommon/android/sourcemap.json', 'utf8'))
);
...
fs.writeFile("meta.json",JSON.stringify(moduleMetas));

// console.info(moduleMetas)
